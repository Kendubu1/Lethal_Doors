...
## Versions & Notes
Leave any comments for improvements or bugs on the github repo! - Will be making future updates to remove the safe zone wait.
- 1.0.0.0 - Initial Release - Seeking helping getting this to work fully server side if possible. New to unity over here :)
- 1.0.0.1 - Updated manifest
- 1.0.0.2 - Added ability to also impact enemies like the Eyeless Dog
